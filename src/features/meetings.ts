...
import { buildAnnouncementBlocks, buildCancelledAnnouncementBlocks, updateAnnouncement as _updateAnnouncement } from '../lib/announcements';
...
const updateAnnouncement = (client: any, env: Env, meeting: Parameters<typeof _updateAnnouncement>[2]) =>
